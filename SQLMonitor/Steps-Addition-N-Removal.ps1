...
Param (
    ...
    [Parameter(Mandatory=$false)]
    [String]$StepName = "26__CreateJobCheckSQLAgentJobs",
    ...
    [String[]]$AllSteps = @( "1__sp_WhoIsActive", "2__AllDatabaseObjects", "3__XEventSession",
                ...
                "25__CreateJobCollectMemoryClerks", "26__CreateJobUpdateSqlServerVersions", "27__CreateJobCheckInstanceAvailability",
                "28__CreateJobGetAllServerInfo", "29__WhoIsActivePartition", "30__BlitzIndexPartition",
                "31__EnablePageCompression", "32__GrafanaLogin", "33__LinkedServerOnInventory",
                "34__LinkedServerForDataDestinationInstance", "35__AlterViewsForDataDestinationInstance"
                ),
