...
Param (
    ...
    [ValidateSet("1__RemoveJob_CollectDiskSpace", "2__RemoveJob_CollectOSProcesses", "3__RemoveJob_CollectPerfmonData",
                ...
                "34__DropView_vw_file_io_stats_deltas", "35__DropView_vw_resource_consumption", "36__DropView_vw_disk_space",
                "37__DropView_vw_all_server_info", "38__DropXEvent_ResourceConsumption", "39__DropLinkedServer",
                "40__DropLogin_Grafana", "41__DropTable_ResourceConsumption", "42__DropTable_resource_consumption_queries",
...
# 35__DropView_vw_resource_consumption
$stepName = '35__DropView_vw_resource_consumption'
if($stepName -in $Steps2Execute) {
    $objName = 'vw_resource_consumption'
    $objType = 'view'
    $objTypeTitleCase = (Get-Culture).TextInfo.ToTitleCase("$objType")
...
# 42__DropTable_resource_consumption_queries
$stepName = '42__DropTable_resource_consumption_queries'
if($stepName -in $Steps2Execute) {
    $objName = 'resource_consumption_queries'
    $objType = 'table'
    $objTypeTitleCase = (Get-Culture).TextInfo.ToTitleCase("$objType")
