...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'dbo.all_server_stable_info', 
		...
		@command=N'sqlcmd -E -b -S localhost -d DBA -Q "EXEC dbo.usp_wrapper_GetAllServerInfo @recipients = ''some_dba_mail_id@gmail.com'', @step_name = ''dbo.all_server_stable_info'';"', 
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'dbo.all_server_volatile_info', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'sqlcmd -E -b -S localhost -d DBA -Q "EXEC dbo.usp_wrapper_GetAllServerInfo @recipients = ''some_dba_mail_id@gmail.com'', @step_name = ''dbo.all_server_volatile_info'';"', 
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'dbo.all_server_collection_latency_info', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'sqlcmd -E -b -S localhost -d DBA -Q "EXEC dbo.usp_wrapper_GetAllServerInfo @recipients = ''some_dba_mail_id@gmail.com'', @step_name = ''dbo.all_server_collection_latency_info'';"', 
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'dbo.usp_populate__all_server_volatile_info_history', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'sqlcmd -E -b -S localhost -d DBA -Q "EXEC dbo.usp_wrapper_GetAllServerInfo @recipients = ''some_dba_mail_id@gmail.com'', @step_name = ''dbo.usp_populate__all_server_volatile_info_history'';"', 
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
